...
CORS(app, resources={
    r"/predict": {
        "origins": [
            ...
            "https://medhelptg-production.up.railway.app",
...
@app.route('/chat/conversation/<conversation_id>', methods=['DELETE', 'OPTIONS'])
def delete_conversation(conversation_id):
    """Handle OPTIONS preflight for DELETE requests."""
