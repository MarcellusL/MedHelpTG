...
CORS(app, resources={
    r"/predict": {"origins": ["https://nexahealth.work", "http://localhost:8080"]},
    r"/chat": {"origins": ["https://nexahealth.work", "http://localhost:8080"]},
    r"/health": {"origins": "*"},
    r"/*": {"origins": ["https://nexahealth.work", "http://localhost:8080"]}
